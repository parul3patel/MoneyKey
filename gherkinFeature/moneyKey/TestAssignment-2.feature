...
Feature: TestAssignment-1 - Create an account Page.
  ...
  Scenario Outline: TestAssignment-1|AC-1 - Happy Path for Create Account Page
    ...
    Examples: 
      ...
      | tester123 | lastTester | testernew@gmail.com | MoneyKey@123 |
  ...
  Scenario Outline: TestAssignment-1|AC-2 - Error Message for Duplicate emailId
    ...
    Examples: 
      ...
      | tester123 | lastTester | testernew@gmail.com | MoneyKey@123 | The email address you supplied already belongs to someone else. Please supply a new email address. |
